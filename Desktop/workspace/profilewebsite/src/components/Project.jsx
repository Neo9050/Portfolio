...
const Project = () => {
  const projectsData = [
    {
      name: `Sumesh k.s - Developer`,
      description: ` I am a MERN Stack Developer. i have done projects on Youtube clone, Linkedin clone and many more.  
      Please Feel free to check it out in my github.`,
      image: `https://miro.medium.com/max/1400/1*aTYOTFS4Vkr-nwHNML3GvQ.jpeg`,
      link: `https://github.com/Neo9050/portfolio.git`,
    },
    {
      name: `Sumesh k.s - Developer`,
      description: ` I am a MERN Stack Developer. i have done projects on Youtube clone, Linkedin clone and many more.  
